  ...
  return (
    ...
    >
      <input
        type="file"
        multiple
        accept=".pdf,.doc,.docx,.rtf,.txt,.ppt,.pptx,.xls,.xlsx,.jpg,.jpeg,.png"
      ...
      <label htmlFor="fileInput" className="cursor-pointer flex flex-col items-center">
        ...
        <p className="text-xs text-gray-400"> Supported formats: PDF, DOC, DOCX, RTF, TXT, PPT, PPTX, XLS, XLSX, JPG, JPEG, PNG</p>
      </label>
    </div>
  );
};
